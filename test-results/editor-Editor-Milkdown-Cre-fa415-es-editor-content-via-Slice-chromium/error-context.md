...
- Name: editor.spec.ts >> Editor (Milkdown Crepe) >> external VaultStore change updates editor content via Slice
- Location: e2e\specs\editor.spec.ts:124:2
  ...
  - complementary [ref=e7]:
    ...
    - navigation [ref=e13]:
      ...
      - generic [ref=e29]:
        ...
        - button "external-note" [ref=e32] [cursor=pointer]:
          - img [ref=e33]
          - generic [ref=e36]: external-note
    - 'button "Workspace: External Update Test" [ref=e38] [cursor=pointer]':
      - generic [ref=e39]: External Update Test
      - img [ref=e40]
  - generic [ref=e43]:
    - banner [ref=e45]:
