...
- Name: editor.spec.ts >> Editor (Milkdown Crepe) >> content from VaultStore appears in editor
- Location: e2e\specs\editor.spec.ts:53:2
...
Locator: locator('.milkdown h1').getByText('Hello World')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.milkdown h1').getByText('Hello World')
...
- complementary:
  ...
  - navigation:
    ...
    - text: Vault
    - button "test-note"
  - 'button "Workspace: Editor Content Test"': Editor Content Test
- banner: Notes2
- main:
  - textbox:
